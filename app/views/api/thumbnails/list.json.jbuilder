...
json.thumbnails @memento_records do |memento|
  ...
  json.thumbanil_uri Rails.configuration.image_stacks_uri+@druid_id+"/"+Was::ThumbnailService::Utilities.convert_date_to_14_digits(memento['memento_datetime'].to_s)+extension 
end