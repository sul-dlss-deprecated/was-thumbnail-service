  ...
  module ThumbnailService
    module Synchronization
      ...
      class TimemapSynchronization
        ...
        def sync_database
          timemap_from_database
          timemap_from_wayback
          diff_mementos = timemap_difference_list
        ...
        def timemap_from_database
          timemap_parser = Was::ThumbnailService::Synchronization::TimemapDatabaseParser.new(@uri)
          @database_memento_hash = timemap_parser.timemap
        end

        def timemap_from_wayback
